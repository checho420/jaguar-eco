...
const Catalog = () => {
    ...
    useEffect(() => {
        ...
        // Price
        result = result.filter(p => p.precio >= priceRange.min && p.precio <= priceRange.max);
            ...
            <div className="container mx-auto px-6 pt-32 py-12">
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <aside className="hidden lg:block w-80 order-1 lg:order-2">
                        <div className="bg-white dark:bg-[#111] p-8 rounded-[40px] border border-gray-100 dark:border-white/5 sticky top-32 shadow-xl shadow-gray-200/50 dark:shadow-none">
                            ...
                            {/* Category Filter */}
                            <div className="mb-10">
                                <h4 className="text-xs font-black uppercase tracking-widest text-gray-400 mb-6 flex items-center justify-between">
                                    Categoría
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="space-y-12">
                                ...
                                <div>
                                    <h4 className="text-xs font-black uppercase tracking-widest text-gray-400 mb-6">Precio Máximo</h4>
                                    <input
                                        type="range"
                                        min="0"
                                        max="2000"
                                    ...
                                    />
                                    <div className="flex justify-between mt-2 font-black text-xs text-blue-500">
                                        <span>$0</span>
