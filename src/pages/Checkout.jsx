    ...
    if (cart.length === 0) {
        return (
            <div className="container mx-auto px-6 py-20 text-center">
                ...
                <Link to="/catalog" className="inline-block bg-green-600 text-white px-6 py-3 rounded-full hover:bg-green-700">Go to Catalog</Link>
            </div>
        );
    }
            ...
            <div className="flex flex-col lg:flex-row gap-12">
                ...
                <div className="w-full lg:w-2/3">
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                        ...
                        <h2 className="text-xl font-semibold mt-8 mb-6 dark:text-white">Payment Method</h2>
                        <div className="p-4 border dark:border-gray-600 rounded-lg text-center text-gray-500 dark:text-gray-400">
                            Payment Mockup - Cash on Delivery / Stripe Integration
                        </div>
                    </div>
                </div>
