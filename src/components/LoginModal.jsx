                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="text-center mb-8">
                            <h2 className="text-3xl font-bold bg-gradient-to-r from-green-500 to-teal-500 bg-clip-text text-transparent">Welcome Back!</h2>
                            <p className="text-gray-500 dark:text-gray-400 mt-2">Access the JaguarEco Command Center</p>
                        </div>
